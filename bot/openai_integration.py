...
async def analyze_food_image(base64_image: str) -> dict:
    ...
    try:
        ...
        Не включай в ответ ничего, кроме JSON. Если невозможно определить какой-то из нутриентов, используй значение 0. Значения белков жиров и углеводов должны быть достаточно точны для подсчета калорий. Калораж должен быть равен Б*4 + Ж*9 + У*4 если блюдо не содержит алкоголь.
        """
